  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-10">
      <div className="max-w-3xl w-full bg-white p-8 rounded-xl shadow-xl">
        ...
        <h1 className="mt-0 mb-3 text-2xl font-semibold">Hover over the elements below</h1>
        <p className="text-gray-500 mb-5">A small demo to show interactive targets styled for emphasis.</p>
        ...
        <div className="flex gap-4 flex-wrap">
          ...
          <a className="cursor-target px-4 py-3 rounded-lg transition transform duration-150 ease-in-out hover:-translate-y-1 text-blue-600" href="#">
            Anchor target
          </a>
        </div>
      </div>
